...
Проект включает автоматически генерируемую Swagger документацию API.

### Главная страница

После запуска сервера главная страница будет доступна по адресу:
...
- **JSON Schema**: http://localhost:8080/swagger/swagger.json
