...
// Source: internal/handlers/health.go
//
// Generated by this command:
//
//	mockgen -source=internal/handlers/health.go -destination=internal/storage/mocks/status_checker.go -package=mocks
//
...
func (mr *MockStatusCheckerMockRecorder) CheckStatus(ctx any) *gomock.Call {
