// Package templates предоставляет HTML-шаблоны для веб-интерфейса сервера.
// Пакет содержит готовые HTML-страницы с встроенными стилями для отображения
// информации о сервисе и навигации к API документации.
package templates

// HomePageHTML возвращает HTML-код главной страницы сервиса GophKeeper.
// Страница содержит информацию о возможностях сервиса, включая аутентификацию,
// шифрование, типы поддерживаемых данных и ссылки на Swagger UI.
//
// Возвращает строку с полным HTML-документом, включающим встроенные CSS-стили
// для современного и адаптивного дизайна.
